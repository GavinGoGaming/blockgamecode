...
public class EntitySelectorReader {
    ...
    public EntitySelector build() {
        ...
        return new EntitySelector(this.limit, this.includesNonPlayers, this.localWorldOnly, List.copyOf(this.predicates), this.distance, function, lv, this.sorter, this.senderOnly, this.playerName, this.uuid, this.entityType, this.usesAt);
    }
